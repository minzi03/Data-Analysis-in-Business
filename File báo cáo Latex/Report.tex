...
Where $\gamma_1, \gamma_2, \gamma_3, ...$ are the coefficients to be estimated from the data.
 ...
 The estimation of the coefficients $\beta_0, \beta_1, \beta_2, \ldots, \beta_n$, $\alpha_1, \beta_1, \alpha_2, \beta_2, \ldots, \alpha_k, \beta_k$, $\gamma_1, \gamma_2, \gamma_3, \ldots$ can be performed using the Ordinary Least Squares (OLS) method or other optimization techniques.
