...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
         ...
         \hline
         \multirow{2}{*}{GRU} & 7:3	& 119.53 &  2.11 & 0.0008 \\ & \textbf{8:2} & 98.64 & 2.00 & 0.0007 \\ & 9:1 & 92.90 & 2.29 & 0.0008 \\
         \hline
         \multirow{2}{*}{ARIMA} & 7:3 & 558.44 & 11.50 & 0.02 \\ & 8:2 & 801.64 & 18.26 & 0.04 \\ & \textbf{9:1} & 290.25 & 5.51 & 0.00\\
         \hline
         \multirow{2}{*}{FFT}& 7:3	& 0.1081& 1113& 0.0091\\ & \textbf{8:2} & 0.0949& 1.43& 0.0071\\ & 9:1 & 0.0997& 1.915& 0.0080\\
         \hline
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bibliography/Figure/FFT_82_AMV.png}
    \caption{FFT model's result with 8:2 splitting proportion}
    \label{fig8}
  \end{minipage}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
         ...
         \hline
         \multirow{2}{*}{GRU} & 7:3	& 1758.60 & 1.76 & 0.0008 \\ & 8:2 & 1168.83 & 1.35 & 0.0003 \\ & \textbf{9:1} & 582.26 &  0.67 & 0.0001 \\
         \hline
         \multirow{2}{*}{ARIMA} & 7:3 & 27750.14  & 39.01  &  0.36 \\ & 8:2 & 7936.36  & 10.027 & 0.01 \\ & \textbf{9:1} & 6394.82 & 7.79 & 0.01 \\
         \hline
         \multirow{2}{*}{FFT}& \textbf{7:3}	& 0.1964& 7& 0.0284\\ & 8:2 & 0.2051& 0.6316& 0.0312\\ & 9:1 & 0.2113& 0.6349& 0.0320\\
         \hline
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bibliography/Figure/FFT_73_DP3.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
         ...
         \hline
         \multirow{2}{*}{GRU} & 7:3	& 741.91 & 1.84 & 0.0008 \\ & \textbf{8:2} & 714.83 & 1.59 & 0.0006 \\ & 9:1 & 1351.59 & 2.96 & 0.0017 \\
         \hline
         \multirow{2}{*}{ARIMA} & 7:3 & 9640.50 & 29.78 &0.24 \\ & 8:2 & 9305.45 &31.50 & 0.18\\ & \textbf{9:1} &5570.55 &12.58 & 0.04\\
         \hline
         \multirow{2}{*}{FFT}& \textbf{7:3}	& 0.5309& 0.7499& 0.1485\\ & 8:2 & 0.6383& 0.8736& 0.2118\\ & 9:1 & 0.6859& 0.8863& 0.2398\\
         \hline
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bibliography/Figure/FFT_73_DHT.png}
    \caption{FFT model's result with 7:3 splitting proportion}
    \label{fig8}
  \end{minipage}
\end{figure}
...
\bibitem{12} Hyndman, R.J. and Athanasopoulos, G., 2018. Forecasting: principles and practice. OTexts.

\bibitem{13} De Livera, A.M., Hyndman, R.J. and Snyder, R.D., 2011. Forecasting time series with complex seasonal patterns using exponential smoothing. Journal of the American Statistical Association, 106(496), pp.1513-1527.
